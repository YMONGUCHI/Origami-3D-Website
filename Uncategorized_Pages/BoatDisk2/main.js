...
loader.load("/GLB_Files/boatdisk2.glb", 
  function(gltf) {
    // Objects
    ...
    const object4 = model.children[3];
    const object5 = model.children[4];
    const object6 = model.children[5];
    const object7 = model.children[6];
...
document.getElementById('colorPicker3').addEventListener('input', myColor3);
